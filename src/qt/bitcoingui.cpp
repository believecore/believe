                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Believe Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BLE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and believe: URIs)"));
    ...
    QPixmap adIconInactive(":/icons/ad");
    QPixmap adIconActive(":/icons/ad_active");
    QIcon adIcon(adIconInactive);

    adAction = new QAction(adIcon, tr("&Advertising"), this);
    adAction->setStatusTip(tr("Set advertisement"));
    adAction->setToolTip(adAction->statusTip());
    adAction->setCheckable(true);
#ifdef Q_OS_MAC
    adAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_7));
#else
    adAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_7));
#endif
    tabGroup->addAction(adAction);
    connect(adAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(adAction, SIGNAL(triggered()), this, SLOT(gotoAdPage()));

    QPixmap mobileIconInactive(":/icons/mobile");
    QPixmap mobileIconActive(":/icons/mobile_active");
    QIcon mobileIcon(mobileIconInactive);

    mobileAction = new QAction(mobileIcon, tr("&MobileApp"), this);
    mobileAction->setStatusTip(tr("Control MobileApp"));
    mobileAction->setToolTip(mobileAction->statusTip());
    mobileAction->setCheckable(true);
#ifdef Q_OS_MAC
    mobileAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_9));
#else
    mobileAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_9));
#endif
    tabGroup->addAction(mobileAction);
    connect(mobileAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(mobileAction, SIGNAL(triggered()), this, SLOT(gotoMobilePage()));

    QPixmap shoppingIconInactive(":/icons/shopping");
    QPixmap shoppingIconActive(":/icons/shopping_active");
    QIcon shoppingIcon(shoppingIconInactive);

    shoppingAction = new QAction(shoppingIcon, tr("&Shopping"), this);
    shoppingAction->setStatusTip(tr("Set shopping"));
    shoppingAction->setToolTip(shoppingAction->statusTip());
    shoppingAction->setCheckable(true);
#ifdef Q_OS_MAC
    shoppingAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_8));
#else
    shoppingAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_8));
#endif
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Believe Core"), this);
    aboutAction->setStatusTip(tr("Show information about Believe Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Believe"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BLE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BLE addresses"));
    ...
    openAction->setStatusTip(tr("Open a believe: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Believe Core help message to get a list with possible Believe command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Believe Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoAdPage()
{
    adAction->setChecked(true);
    if (walletFrame) walletFrame->gotoAdPage();
}

void BitcoinGUI::gotoMobilePage()
{
    mobileAction->setChecked(true);
    if (walletFrame) walletFrame->gotoMobilePage();
}

void BitcoinGUI::gotoShoppingPage()
{
    shoppingAction->setChecked(true);
    if (walletFrame) walletFrame->gotoShoppingPage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Believe network", "", count));
}
...
{
    QString strTitle = tr("Believe Core"); // default title
