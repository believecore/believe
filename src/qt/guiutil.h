...
/** Utility functions used by the Believe Qt UI.
 */
namespace GUIUtil
{
...
// Render BLE addresses in monospace font
...
// Parse "believe:" URI into recipient object, return true on successful parsing
