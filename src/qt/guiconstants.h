...
/* Believe GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Believe"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "Believe-Qt"
#define QAPP_APP_NAME_TESTNET "Believe-Qt-testnet"
