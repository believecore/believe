                                          ...
                                          walletModel(0)
{
    ...
    adPage = new AdDialog();
    addWidget(adPage);
    mobilePage = new MobileDialog();
    addWidget(mobilePage);
    shoppingPage = new ShoppingDialog();
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    adPage->setClientModel(clientModel);
    mobilePage->setClientModel(clientModel);
}
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    adPage->setModel(walletModel);
    mobilePage->setModel(walletModel);
...
void WalletView::gotoAdPage()
{
    adPage->getSetting();
    setCurrentWidget(adPage);
}

void WalletView::gotoMobilePage()
{
    mobilePage->getSetting();
    setCurrentWidget(mobilePage);
}
