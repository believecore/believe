...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Believe server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Believe features */
        {"believe", "masternode", &masternode, true, true, false},
        {"believe", "listmasternodes", &listmasternodes, true, true, false},
        {"believe", "getmasternodecount", &getmasternodecount, true, true, false},
        {"believe", "masternodeconnect", &masternodeconnect, true, true, false},
        {"believe", "masternodecurrent", &masternodecurrent, true, true, false},
        {"believe", "masternodedebug", &masternodedebug, true, true, false},
        {"believe", "startmasternode", &startmasternode, true, true, false},
        {"believe", "createmasternodekey", &createmasternodekey, true, true, false},
        {"believe", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"believe", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"believe", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"believe", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"believe", "getmasternodescores", &getmasternodescores, true, true, false},
        {"believe", "mnbudget", &mnbudget, true, true, false},
        {"believe", "preparebudget", &preparebudget, true, true, false},
        {"believe", "submitbudget", &submitbudget, true, true, false},
        {"believe", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"believe", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"believe", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"believe", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"believe", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"believe", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"believe", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"believe", "checkbudgets", &checkbudgets, true, true, false},
        {"believe", "mnsync", &mnsync, true, true, false},
        {"believe", "spork", &spork, true, true, false},
        {"believe", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"believe", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"believe", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"believe", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"believe", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"believe", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> believe-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33671/\n";
}
