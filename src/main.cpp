...
#if defined(NDEBUG)
#error "Believe cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uble) are considered zero fee (for relaying and mining)
...
int64_t GetPosValue(int nHeight)
{
    int64_t nSubsidy = 0;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight < 50) {
        ...
        ret = blockValue - GetPosValue(nHeight);
    }
